...
class ConditionalLogic:
    ...
    def should_continue_annual_report(self, state: AgentState):
        """Determine if annual-report analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_annual_report"
        return "Msg Clear Annual Report"
    ...
    def should_continue_industry_chain(self, state: AgentState):
        ...
        return "Msg Clear Industry Chain"
