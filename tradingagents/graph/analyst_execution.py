...
ANALYST_NODE_SPECS: dict[str, AnalystNodeSpec] = {
    ...
    "social": AnalystNodeSpec(
        ...
        # user-facing label is "Sentiment Analyst"; in the A-share build this
        # analyst ingests Wind news, market context, and company-event blocks.
        key="social",
    ...
    "annual_report": AnalystNodeSpec(
        key="annual_report",
        agent_node="Annual Report Analyst",
        clear_node="Msg Clear Annual Report",
        tool_node="tools_annual_report",
        report_key="annual_report",
    ),
    "industry_chain": AnalystNodeSpec(
        key="industry_chain",
        agent_node="Industry Chain Analyst",
        clear_node="Msg Clear Industry Chain",
